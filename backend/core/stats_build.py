...
def build_stats_summary(reviews: List[Dict], top_keywords: Dict[str, List[str]], keyword_matched_samples: Dict[str, Dict[str, str]], n_samples: int = 3) -> Dict[str, Any]:
    ...
    for sentiment in ['positive', 'neutral', 'negative']:
        ...
        probs = [r.get('sentiment_probabilities', {}).get(idx, None) for r in reviews]
